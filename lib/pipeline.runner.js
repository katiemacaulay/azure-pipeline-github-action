...
class PipelineRunner {
    ...
    RunYamlPipeline(webApi) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let buildResult;
            do {
                yield new Promise(resolve => setTimeout(resolve, buildResult ? 60000 : 0));
                buildResult = yield buildApi.getBuild(projectName, buildQueueResult.id);
            ...
            logger_1.Logger.LogInfo(`Build Status = "${BuildInterfaces.BuildStatus[buildResult.status]}"`);
            logger_1.Logger.LogInfo(`Build Result = "${BuildInterfaces.BuildResult[buildResult.result]}"`);
            ...
            logger_1.Logger.LogInfo("Build succeed.");
            logger_1.Logger.LogOutputUrl(buildResult._links.web.href);
        });
    }
